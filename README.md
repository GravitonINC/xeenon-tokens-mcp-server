...
| repay | ✅ | Repay a CREDIEZ loan | Private key, RPC, CREDIEZ Balance, Loan Balance |
| donateLiquidity | ✅ | Donate tokens to liquidity pool | Private key, RPC, CREDIEZ Balance |